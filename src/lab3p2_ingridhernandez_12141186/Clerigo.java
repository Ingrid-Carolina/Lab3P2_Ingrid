...
public class Clerigo extends Personaje {
    ...
    public Clerigo(String dios, String invocacion, String nombre, String raza, double estaura, double peso, int edad, String descripcion, String nacionalidad, String Tp) {
